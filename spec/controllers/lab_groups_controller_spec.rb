describe LabGroupsController do
  describe "join" do
    ...
    src1 = Factory.create(:student_registered_for_course, 
      given_course: gc, student: student1)
    src2 = Factory.create(:student_registered_for_course, 
      given_course: gc, student: student2)
